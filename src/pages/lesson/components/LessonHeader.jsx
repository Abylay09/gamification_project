    ...
    return (
        <>
            <div className='d-flex align-items-center justify-content-between px-2'>
                <div onClick={() => navigate(`/lessons/${prev ? prev : "11870796-3253-11ed-a261-0242ac120002"}`)}>
                ...
                <div onClick={() => navigate(`/lessons/${next ? next : "11870796-3253-11ed-a261-0242ac120002"}`)}>
