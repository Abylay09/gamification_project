...
function ShopItem({ merchant_title, title, level, data, price, openTicket, hasbuy }) {
    return (
        <>
    
            <div onClick={openTicket} className={`coupon mb-4 d-flex align-items-center justify-content-between ${hasbuy ? "" : "not-active"}`} >
                <div>
